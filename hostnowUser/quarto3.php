    ...
    <section class="bemvindo">
        <div class="container">
            <div class="bemvindo-text">
                <img src="img/quarto3-1.jpeg" alt="">
            </div>
            <div class="bemvindo-text">
                <img src="img/quarto3-2.jpeg" alt="">
            </div>

            <div class="bemvindo-text">
                <img src="img/quarto3-3.jpeg" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="bemvindo">
        <div class="container">
            <div class="bemvindo-text">
                ...
                <p>Essas acomodações ainda oferecem amenities especiais, TV LCD a cabo, telefone, banheiro com box, 
                   secador de cabelo, espelho de aumento, frigobar, ar-condicionado, máquina de café, fechadura e cofre eletrônicos. </p>
    ...
    <section class="bemvindo">
        <div class="container">
            ...
            <div class="bemvindo-text">
                ...
                <br><br> <a class="btn" href="quarto4.php">VER PROXÍMO ➞</a>
