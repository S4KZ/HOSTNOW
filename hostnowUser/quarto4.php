...
<body>
    ...
    <section class="bemvindo">
        <div class="container">
            <div class="bemvindo-text">
                <img src="img/quarto4-1.jpeg" alt="">
            </div>
            <div class="bemvindo-text">
                <img src="img/quarto4-2.jpeg" alt="">
            </div>

            <div class="bemvindo-text">
                <img src="img/quarto4-3.jpeg" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="bemvindo">
        <div class="container">
            <div class="bemvindo-text">
                <h3>Suíte de Luxo</h3>
                <p>Considerada a mais nobre dentre as categorias de quartos de hotéis e pousadas, 
                uma Suíte Luxo é voltada àqueles turistas que valorizam o melhor da vida, pois proporciona momentos de conforto e comodidade extrema.</p>
    ...
    <section class="bemvindo">
        <div class="container">
            ...
            <div class="bemvindo-text">
                ...
                <br><br> <a class="btn" href="quarto5.php">VER PROXÍMO ➞</a>
