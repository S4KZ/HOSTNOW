    ...
    <section class="bemvindo">
        <div class="container">
            <div class="bemvindo-text">
                <img src="img/quarto5-1.jpeg" alt="">
            </div>
            <div class="bemvindo-text">
                <img src="img/quarto5-2.jpeg" alt="">
            </div>

            <div class="bemvindo-text">
                <img src="img/quarto5-3.jpeg" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="bemvindo">
        <div class="container">
            <div class="bemvindo-text">
                ...
                <p>O quarto familiar é a junção de 2 quartos duplos comunicantes, 
                dando maior espaço às famílias, mas ao mesmo tempo privacidade.</p>
    ...
    <section class="bemvindo">
        <div class="container">
            ...
            <div class="bemvindo-text">
                ...
                <br><br> <a class="btn" href="quarto1.php">⬅️ VOLTAR</a>
